...
class Repeat:
    ...
    def divergence(self, score_type):
        if not hasattr(self, 'dDivergence') or score_type not in self.dDivergence:
            self.calculate_scores(scoreslist=[score_type])
    ...
    def calc_index_msa(self):
        ...
        index = list(range(self.begin + self.sequence_length - 1, self.begin - 1, -1))  # python 2: range returns list by default
    ...
    def calculate_scores(self, scoreslist=config['scoreslist']):
        ...
        if self.lD == 0:  # Enter worst score
            ...
            if 'parsimony' in scoreslist:
                self.dScore['parsimony'] = \
                    np.round_(repeat_score.meanSimilarity(self, repeat_score.parsimony),
            ...
            if 'phylo_gap01_ignore_coherent_deletions' in scoreslist:
                self.dDivergence['phylo_gap01_ignore_coherent_deletions'], self.dScore['phylo_gap01_ignore_coherent_deletions'] = \
                    repeat_score.phyloStarTopology_local(self, gaps='ignore_coherent_deletions', indelRatePerSite=0.01)
            ...
            if 'phylo_gap001' in scoreslist:
                self.dDivergence['phylo_gap001'], \
                    self.dScore['phylo_gap001'] = \
                    repeat_score.phyloStarTopology_local(self, gaps='row_wise', indelRatePerSite=0.001)
            if 'phylo_gap001_ignore_trailing_gaps' in scoreslist:
                self.dDivergence['phylo_gap001_ignore_trailing_gaps'], self.dScore['phylo_gap001_ignore_trailing_gaps'] = \
                    repeat_score.phyloStarTopology_local(self, gaps='ignore_trailing_gaps', indelRatePerSite=0.001)
            if 'phylo_gap001_ignore_coherent_deletions' in scoreslist:
                self.dDivergence['phylo_gap001_ignore_coherent_deletions'], self.dScore['phylo_gap001_ignore_coherent_deletions'] = \
                    repeat_score.phyloStarTopology_local(self, gaps='ignore_coherent_deletions', indelRatePerSite=0.001)
            if 'phylo_gap001_ignore_trailing_gaps_and_coherent_deletions' in scoreslist:
                self.dDivergence['phylo_gap001_ignore_trailing_gaps_and_coherent_deletions'], self.dScore['phylo_gap001_ignore_trailing_gaps_and_coherent_deletions'] = \
                    repeat_score.phyloStarTopology_local(self, gaps='ignore_trailing_gaps_and_coherent_deletions', indelRatePerSite=0.001)
    ...
    def calculate_pValues(self, scoreslist=config['scoreslist']):
        ...
        if self.lD == 0:  # Enter worst p-value
            ...
            if 'phylo_gap01_ignore_trailing_gaps' in scoreslist:
                self.dPValue['phylo_gap01_ignore_trailing_gaps'] = \
                    repeat_pvalue.pValueFromEmpiricialList(self, 'phylo_gap01', self.score('phylo_gap01_ignore_trailing_gaps'))
            if 'phylo_gap01_ignore_coherent_deletions' in scoreslist:
                self.dPValue['phylo_gap01_ignore_coherent_deletions'] = \
                    repeat_pvalue.pValueFromEmpiricialList(self, 'phylo_gap01', self.score('phylo_gap01_ignore_coherent_deletions'))
            if 'phylo_gap01_ignore_trailing_gaps_and_coherent_deletions' in scoreslist:
                self.dPValue['phylo_gap01_ignore_trailing_gaps_and_coherent_deletions'] = \
                    repeat_pvalue.pValueFromEmpiricialList(self, 'phylo_gap01', self.score('phylo_gap01_ignore_trailing_gaps_and_coherent_deletions'))
            if 'phylo_gap001' in scoreslist:
                self.dPValue['phylo_gap001'] = \
                    repeat_pvalue.pValueFromEmpiricialList(self, 'phylo_gap001')
            if 'phylo_gap001_ignore_trailing_gaps' in scoreslist:
                self.dPValue['phylo_gap001_ignore_trailing_gaps'] = \
                    repeat_pvalue.pValueFromEmpiricialList(self, 'phylo_gap001', self.score('phylo_gap001_ignore_trailing_gaps'))
            if 'phylo_gap001_ignore_coherent_deletions' in scoreslist:
                self.dPValue['phylo_gap001_ignore_coherent_deletions'] = \
                    repeat_pvalue.pValueFromEmpiricialList(self, 'phylo_gap001', self.score('phylo_gap001_ignore_coherent_deletions'))
            if 'phylo_gap001_ignore_trailing_gaps_and_coherent_deletions' in scoreslist:
                self.dPValue['phylo_gap001_ignore_trailing_gaps_and_coherent_deletions'] = \
                    repeat_pvalue.pValueFromEmpiricialList(self, 'phylo_gap001', self.score('phylo_gap001_ignore_trailing_gaps_and_coherent_deletions'))
