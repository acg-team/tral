...
# INSTALLING HMMER development version ##### 
...
git clone https://github.com/EddyRivasLab/hmmer $TRAL_EXT_SOFTWARE 
} || { 
...
( 
{ 
cd $INSTALLATION_PATH/hmmer 
mkdir -p lib/easel 
git clone https://github.com/EddyRivasLab/easel lib/easel 
(cd lib/easel; git checkout develop) 
ln -s lib/easel/aclocal.m4 aclocal.m4 
} && { 
autoconf 
